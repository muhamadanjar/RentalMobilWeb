...
<form role="form" method="POST" enctype="multipart/form-data" action="{{ route('backend.tenagakerja.puk.post') }}">
	<div class="row">
		<div class="col-md-12">
				...
				<div class="panel-heading with-border">
					...
					<div class="panel-toolbar text-right">
                        <div class="btn-group pull-right">
                            ...
                            <a href="{{ route('backend.tenagakerja.puk.index') }}" class=" btn btn-sm btn-primary">
