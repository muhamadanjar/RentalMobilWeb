...
@section('title','Titik Transmigrasi')
...
if(session('aksi') == 'edit'){
    ...
    $x = $titik->x;
    $y = $titik->y;
	$x_decimal = $titik->x_decimal;
	$y_decimal = $titik->y_decimal;
...
<form role="form" method="POST" enctype="multipart/form-data" action="{{ route('backend.titiktransmigrasi.post') }}">
	<div class="row">
		<div class="col-md-8">
			<div class="panel panel-default">
				<div class="panel-heading with-border">
					<h6 class="panel-title"><i class="fa fa-building"></i> Tambah Data Sebaran Transmigrasi</h6>
				...
				<div class="panel-body">
                    ...
                    <div class="form-group">
                            <div class="row">
                                <div class="col-sm-6">
                                    <label class="control-label"> Kordinat</label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12 mb10">
                                    <input type="text" class="form-control" name="x" value="{{ $x }}" placeholder="Kordinat Geografis x">        
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12 mb10">
                                    <input type="text" class="form-control" name="y" value="{{ $y }}" placeholder="Kordinat Geografis y">        
                                </div>
                            </div>
					</div>
					...
					<div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-12 mb10">
                                    <input type="text" class="form-control" name="x_decimal" value="{{ $x_decimal }}" placeholder="Kordinat Desimal x">        
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12 mb10">
                                    <input type="text" class="form-control" name="y_decimal" value="{{ $y_decimal }}" placeholder="Kordinat Desimal y">        
                                </div>
                            </div>
					</div>
