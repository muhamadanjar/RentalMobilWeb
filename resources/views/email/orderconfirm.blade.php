...
<html>
  <head>
    ...
    <title>Transaksi Trans Utama</title>
    <style>
    /* -------------------------------------
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                    <tr>
                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                        ...
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Pesanan anda dengan Kode Booking {{$data['no_transaksi']}} telah terkonfirmasi.</p>
                            ...
                            <tr>
                              <td align="left" valign="top" class="m_-351366858515564487tdp5">
                                  <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                      ...
                                      <tr>
                                      <td align="left" class="m_-351366858515564487tdp5">
                                        <span style="font-size:10px;color:#9e9e9e;line-height:16px">Pelanggan :</span><br>
                                        <span style="font-size:12px;line-height:16px;font-weight:bold">{{$data['customer']}}</span>
                                      </td>
                                      </tr>
                                      </tbody>
                                  </table>
              ...
              <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                <tr>
                  <td class="content-block" style="font-family: sans-serif; vertical-align: top; padding-bottom: 10px; padding-top: 10px; font-size: 12px; color: #999999; text-align: center;">
                    <span class="apple-link" style="color: #999999; font-size: 12px; text-align: center;">Trans Utama, Aceh 94102</span>
                    <br> Don't like these emails? <a href="http://i.imgur.com/CScmqnj.gif" style="text-decoration: underline; color: #999999; font-size: 12px; text-align: center;">Unsubscribe</a>.
                  </td>
                </tr>
                <tr>
                  <td class="content-block powered-by" style="font-family: sans-serif; vertical-align: top; padding-bottom: 10px; padding-top: 10px; font-size: 12px; color: #999999; text-align: center;">
                    Powered by <a href="http://transutama.com" style="color: #999999; font-size: 12px; text-align: center; text-decoration: none;">Trans Utama</a>.
                  </td>
                </tr>
              </table>
            </div>
